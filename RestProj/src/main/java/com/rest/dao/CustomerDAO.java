...
public class CustomerDAO {
	...
	{
		System.out.println("CustomerDAO::static block called");
	 ...
	 */
	public List list() {
		System.out.println("CustomerDAO::list() called");
		return customers;
	}
	...
	public Customer get(Long id) {
		System.out.println("CustomerDAO::get() called");
	...
	public Customer create(Customer customer) {
		System.out.println("CustomerDAO::create() called");
	...
	public Long delete(Long id) {
		System.out.println("CustomerDAO::delete() called");
		for (Customer c : customers) {
			if (c.getId().equals(id)) {
				customers.remove(c);
				return id;
